 ...
 */
  ...
  ?>
<div data-color="#08B7B7, #B75F08, #5F08B7, #08B760, #3342FF, #B70860, #E20A0A"> 
    ...
    >
        <div class="ls-tilt" style="width: 100%;">
            <div class="layerslider-container-inner" style="max-width: 600px; margin: 0 auto;">
                <div id="homepageLargeSlider"  style="width: 600px; height: 600px;">
                    ...
                    <div class="ls-slide">
                        ...
                        >
                            <?php get_template_part('img/Right Brain Sections/inline', '1.svg'); ?>
                        </div>
                        ...
                        >
                            <?php get_template_part('img/Right Brain Sections/inline', '2.svg'); ?>
                        </div>
                        ...
                        >
                            <?php get_template_part('img/Right Brain Sections/inline', '3.svg'); ?>
                        </div>
                        ...
                        >
                            <?php get_template_part('img/Right Brain Sections/inline', '4.svg'); ?>
                        </div>
                        ...
                        >
                            <?php get_template_part('img/Right Brain Sections/inline', '5.svg'); ?> 
                        </div>
                        ...
                        >
                            <?php get_template_part('img/Right Brain Sections/inline', '6.svg'); ?>
                        </div>
                        ...
                        >
                            <?php get_template_part('img/Right Brain Sections/inline', '7.svg'); ?>
                        </div>
